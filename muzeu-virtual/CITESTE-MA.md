...
## Site-ul (o singură pagină: `index.html`)
...
Butonul „Copiază link" din CMS îți dă linkul gata de QR:
`index.html?DOS-00001` — deschide direct fereastra modală a dosarului.
Folosește adresa reală de GitHub Pages (ex: `https://rzvn332.github.io/muzeu-virtual/index.html?DOS-00001`).

## Linkuri directe
- Prima pagină (harta): `index.html?home` (orice refresh ajunge aici)
- Muzeul unui raion: `index.html?chisinau`
- Un sat: `index.html?chisinau/truseni`
- Un dosar deschis în panou: `index.html?chisinau/truseni&dosar=DOS-00001`
- Panoul de administrare: `index.html?page=admin` (te redirecționează la Apps Script)
